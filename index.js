 ...
 * @param {string} status Status sesi (Connected, Pairing, Logged Out)
 */
...
app.post("/api/pair", async (req, res) => {
    ...
    try {
        ...
        // PENTING: ID mapping sekarang support sistem ini karena menggunakan sessionId yang unik.
...
app.get("/api/sessions", (req, res) => {
    ...
    sessionsMap.forEach((client, sessionId) => {
        ...
        active.push({ 
            ...
            number: number,
            sessionFolder: sessionId, // Tambahkan informasi folder sesi
            // Tambahkan status broadcast untuk UI
